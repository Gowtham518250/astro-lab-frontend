      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
        ...
        >
          <a 
            ...
            className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-400 px-8 py-4 text-lg font-bold text-white shadow-[0_0_30px_rgba(34,211,238,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_50px_rgba(139,92,246,0.6)]"
          >
